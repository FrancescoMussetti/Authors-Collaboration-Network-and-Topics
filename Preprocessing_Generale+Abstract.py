...
# df_selected.to_excel('Dataset_Corona_2000_2019_COMPLETO.xlsx', index=False, sheet_name='Sheet1', startrow=0, startcol=0)
#
# # apre il file Excel appena creato
# os.startfile('Dataset_Corona_2000_2019_COMPLETO.xlsx')
# #
#
#
#
